...
public class S2CKeybindRelease implements Message<ClientMessageHandler> {
    private final @NotNull String pluginSlug;
    private final int keycode;

    public S2CKeybindRelease(@NotNull String pluginSlug, int keycode) {
        this.pluginSlug = pluginSlug;
        this.keycode = keycode;
    }

    public S2CKeybindRelease(MessageReader reader) {
